...
function remove_custom($wp_customize) {
  $wp_customize->remove_setting('health_home_page_customizer');
  $wp_customize->remove_section('slider_section_settings');
...
add_action( 'after_setup_theme', 'medical_treatment_setup' ); 	
   	...
   	{	
		...
		load_theme_textdomain( 'medical_treatment', get_stylesheet_directory() . '/languages' );
	}
